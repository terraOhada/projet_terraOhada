            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Notre solution est en <strong>version initiale (V1)</strong>.
                  Elle se concentre sur l'essentiel : <br /> vous permettre de
                  rechercher facilement des décisions de jurisprudence OHADA{" "}
                  <br /> via notre moteur de recherche, accessible depuis votre
                  espace personnel.
                </p>
              </div>
            </div>
          ...
          <section className="text-center py-8 bg-blue-50 rounded-xl">
            <div className="max-w-2xl mx-auto px-4">
              ...
              <ul className="list-disc list-inside space-y-2 mb-6">
                <li>
                  Une <strong>FAQ</strong> est en cours de rédaction pour
                  répondre à vos questions les plus fréquentes
                </li>
                <li>
                  Une <strong>assistance par mail ou</strong> est disponible en
                  cas de bésoin{" "}
                </li>
              </ul>
              <a
